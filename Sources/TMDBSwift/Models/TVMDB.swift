...
extension TVMDB {
    ...
    public static func credits(tvShowID: Int!, language: String?  = nil, completion: @escaping (_ clientResult: ClientReturn, _ data: TVCreditsMDB?) -> Void) {
        Client.TV(String(tvShowID) + "/credits", page: nil, language: language) { apiReturn in
