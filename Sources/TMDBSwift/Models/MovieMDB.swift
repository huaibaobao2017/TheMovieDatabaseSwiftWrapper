...
extension MovieMDB {
    ...
    public static func credits(movieID: Int!, language: String?  = nil, completion: @escaping (_ clientReturn: ClientReturn, _ credits: MovieCreditsMDB?) -> Void) {
        Client.Movies(String(movieID) + "/credits", page: nil, language: language) { apiReturn in
